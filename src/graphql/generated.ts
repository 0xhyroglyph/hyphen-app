...
export const OrConditionFieldsNoRecursiveFragmentDoc = `
  ...
  criteria {
    ...
    `;
export const AuthenticationDocument = `
...
export const useAuthenticationMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<AuthenticationMutation, TError, AuthenticationMutationVariables, TContext>) => {
    
    return useMutation<AuthenticationMutation, TError, AuthenticationMutationVariables, TContext>(
      ['authentication'],
      (variables?: AuthenticationMutationVariables) => fetchData<AuthenticationMutation, AuthenticationMutationVariables>(AuthenticationDocument, variables)(),
      options
    )};
...
export const useDefaultProfileQuery = <
    ...
    return useQuery<DefaultProfileQuery, TError, TData>(
...
export const useRefreshMutation = <
    ...
    return useMutation<RefreshMutation, TError, RefreshMutationVariables, TContext>(
      ['Refresh'],
      (variables?: RefreshMutationVariables) => fetchData<RefreshMutation, RefreshMutationVariables>(RefreshDocument, variables)(),
      options
    )};
